...
class _HomeState extends State<Home> {
  ...
  int _whoWon = 0;
  IconData _crossIcon = FontAwesomeIcons.bomb;
  IconData _circleIcon = FontAwesomeIcons.canadianMapleLeaf;
  IconData _neutralIcon = FontAwesomeIcons.cat;
  IconData _drawIcon = FontAwesomeIcons.award;
  @override
